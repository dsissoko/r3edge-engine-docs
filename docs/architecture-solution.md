...
|                  | Internet           | PostgreSQL/TimeScaleDB            | Base de données relationnelle en PaaS, haute disponibilité et sauvegardes gérées. L'addon TimeScaleDB optimise les données temporelles. | TODO   |
